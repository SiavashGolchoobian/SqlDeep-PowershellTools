...
<#
$myLogWriter=New-LogWriter -EventSource ($env:computername) -Module "BackupShipping" -LogToConsole -LogToFile -LogFilePath "U:\Databases\Audit\BackupShipping_{Date}.txt" -LogToTable -LogInstanceConnectionString "Data Source=DB-MN-DLV02.SAIPACORP.COM.LOCAL\NODE,49149;Initial Catalog=EventLog;Integrated Security=True;TrustServerCertificate=True;Encrypt=True" -LogTableName "[dbo].[Events]"
