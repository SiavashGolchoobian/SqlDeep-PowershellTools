...
$myTargetConnectionString='Data Source=172.18.3.49,2019;Initial Catalog=SqlDeep;user=sa;password=Armin1355$;TrustServerCertificate=True;Encrypt=True'
...
#Sample #1: Export Sourcedb dacpac file, compare it withtarget database and publish changes to target
    ...
    Write-Host "Phase 2: Get pre-publish report for changes between Source dacpac and Target Database"
    ...
    Write-Host "Phase 3: Publish Source dacpac to Target Database"
